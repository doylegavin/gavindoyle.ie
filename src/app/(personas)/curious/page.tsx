      ...
      <div className="netflix-page">
        ...
        <NavSection title="Basketball Achievements">
          ...
          <NetflixCard
            ...
            subtitle="Official"
            description="How cute am I - official scholarship photo."
            imageUrl="/images/bballscholarship.JPG"
            tags={["Scholarship", "Official", "Achievement"]}
            imagePosition={8}
          />
          <NetflixCard
          ...
          <NetflixCard
            title="2004 Drip"
            subtitle="Bagging shorts era"
            description="Lowkey we we're dripping hard (bring back bagging shorts) - school team photo."
            imageUrl="/images/2004bballdrip.JPG"
            tags={["2004", "Drip", "School"]}
          />
          <NetflixCard
            title="Big Arms"
            subtitle="Looking strong"
            description="My arms look good here that is all - basketball physique."
            imageUrl="/images/bballbigarms.jpg"
            tags={["Arms", "Strong", "Basketball"]}
            imagePosition={8}
          />
        </NavSection>
        ...
        <NavSection title="Oasis Obsession">
          ...
          />
          <NetflixCard
            title="Drinking Guinness Post-Oasis"
            subtitle="With David"
            ...
            tags={["Guinness", "David", "Oasis"]}
          />
          <NetflixCard
            title="I Love Oasis"
            subtitle="Unhealthy obsession"
            ...
            tags={["Oasis", "Obsession", "Top 0.01%"]}
          />
          <NetflixCard
            title="Olympics Rugby"
            subtitle="COYBIG"
            description="Come on you girls in green - supporting Ireland at the Olympics rugby."
        ...
        <NavSection title="Belfast Friends">
          ...
          <NetflixCard
            title="Belfast Blur"
            subtitle="Blurry year"
            description="The whole year I lived in Belfast was a blur tbh - the nightlife was intense."
            imageUrl="/images/belfastblur.jpg"
            tags={["Belfast", "Blur", "Nightlife"]}
          />
          <NetflixCard
            title="Sad Boys"
          ...
          />
          <NetflixCard
            title="Sad Boys City Hall"
            subtitle="National Startup Awards"
            description="Best dressed boys at the National Start Up Awards - the sad boys clean up well."
            imageUrl="/images/SadBoysatCityHall.jpeg"
            tags={["Sad Boys", "Awards", "Dressed Up"]}
            imagePosition={7}
          />
        </NavSection>

        {/* Best Friends */}
        <NavSection title="Best Friends & Social">
          <NetflixCard
          ...
          <NetflixCard
            ...
            description="MY GORGEOUS FRIEND SOPHIE - she's amazing."
          ...
          <NetflixCard
            ...
            subtitle="My crew"
            description="My Dogpatch girlies - friends from the startup community."
            imageUrl="/images/DogpatchGirls.jpg"
            tags={["Dogpatch", "Girlies", "Startup"]}
            imagePosition={7}
          />
          <NetflixCard
            title="Hot Pot Squad"
            subtitle="Teaching Chinese about Chinese food"
            description="Teaching the Chinese about Chinese food - hot pot adventures."
            imageUrl="/images/HotPotSquad.jpeg"
            tags={["Hot Pot", "Chinese Food", "Squad"]}
            imagePosition={6}
          />
          <NetflixCard
            title="Bless Up"
            subtitle="Good vibes"
            description="BLESSUP - positive energy with friends."
            imageUrl="/images/blessup.JPG"
            tags={["Bless Up", "Vibes", "Friends"]}
          />
          <NetflixCard
            title="Patrick Squared"
            subtitle="Two Patricks"
            description="My two favourite Patricks - great friends."
            imageUrl="/images/PatrickSquared.JPG"
            tags={["Patrick", "Friends", "Duo"]}
          />
          <NetflixCard
            title="The Viscount Boys"
            subtitle="Regular spot"
            description="80% chance you'll find these boys in the Viscount."
            imageUrl="/images/TheViscountBoys.JPG"
            tags={["Viscount", "Boys", "Pub"]}
          />
          <NetflixCard
            title="Digital Camera Boys"
            ...
            tags={["Digital Camera", "Boys", "Photography"]}
          />
          <NetflixCard
            title="Sir Ralph"
            subtitle="Distinguished gentleman"
            description="Such a distinguished gentleman - Sir Ralph the legend."
            imageUrl="/images/SirRalph.jpeg"
            tags={["Ralph", "Distinguished", "Gentleman"]}
            imagePosition={7}
          />
          <NetflixCard
            title="ADK"
            subtitle="Baldoyle Bros"
            description="Myself and ADK - Baldoyle boys together."
            imageUrl="/images/BaldoyleBros.JPG"
            tags={["ADK", "Baldoyle", "Bros"]}
          />
          <NetflixCard
            title="Kate O'Connor"
            subtitle="Olympic friend"
            description="Glad to see one of my fans doing well for herself (Kate O'Connor, Olympian, World Silver medalist, Irish Sportsperson of the year)."
            imageUrl="/images/personas/fans/me-and-kateoconnor-at-a-ball.JPG"
            tags={["Kate O'Connor", "Olympian", "Friend"]}
            imagePosition={8}
          />
        </NavSection>
        ...
        <NavSection title="Coffee Culture">
          ...
          />
          <NetflixCard
            title="With Eric the Wizard"
            subtitle="Favourite barista"
            ...
            tags={["3fe", "Eric", "Wizard"]}
          />
          <NetflixCard
            title="Eric of Wizards"
            subtitle="Don't mess"
            description="Dont mess with the Wizard - Eric the legend."
            imageUrl="/images/EricOfWizards.jpg"
            tags={["Eric", "Wizard", "Legend"]}
            imagePosition={8}
          />
          <NetflixCard
            title="Latte Art"
          ...
          />
          <NetflixCard
            title="Getting Coffee 2"
            subtitle="Daily ritual"
            description="Hey man do you like coffee man - daily coffee shop visits."
            imageUrl="/images/personas/suitors/me-getting-coffee.JPG"
            tags={["Coffee", "Daily", "Ritual"]}
          />
        </NavSection>
        ...
        <NavSection title="Travel & Adventures">
          ...
          />
          <NetflixCard
            title="Scotland Mountains"
            subtitle="Hiking adventure"
            description="In the Scottish Mountains - exploring the highlands."
            imageUrl="/images/personas/suitors/gav-in-scottish-mountains.jpg"
            tags={["Scotland", "Mountains", "Hiking"]}
          />
          <NetflixCard
            title="Scotland Hike"
            subtitle="Trail time"
            description="On a hike in Scotland - breathtaking views."
            imageUrl="/images/personas/suitors/gav-on-hike-scotland.jpg"
            tags={["Scotland", "Hike", "Nature"]}
          />
          <NetflixCard
            title="Italy Drinks"
            subtitle="La dolce vita"
            description="In Italy out for drinkies - living the Italian dream."
          ...
          <NetflixCard
            ...
            description="SF Pier ft. the seals - San Francisco vibes."
          ...
          <NetflixCard
            ...
            subtitle="Ooh Ah"
            description="Ooh Ah - Irish pride captured on digital camera."
            imageUrl="/images/IrishFlagDigital.jpg"
            tags={["Ireland", "Flag", "Pride"]}
            imagePosition={8}
          />
        </NavSection>
        ...
        <NavSection title="Lifestyle & Personality">
          ...
          <NetflixCard
            title="Gym Legs"
            subtitle="Never skip"
            description="Arm day... just kidding, always leg day."
            imageUrl="/images/personas/suitors/gav-in-gym-legs.jpg"
            tags={["Gym", "Legs", "Fitness"]}
            imagePosition={8}
          />
          <NetflixCard
            title="Mirror Pic"
            subtitle="Love this mirror"
            description="Man I love this mirror - gym progress tracking."
            imageUrl="/images/personas/suitors/gav-mirror-pic.jpg"
            tags={["Mirror", "Gym", "Progress"]}
            imagePosition={8}
          />
          <NetflixCard
            title="Mirror Pic 2"
            subtitle="Still love it"
            description="Man I love this mirror x2 - keeping consistent."
            imageUrl="/images/personas/suitors/gav-mirror-pic2.jpg"
            tags={["Mirror", "Consistent", "Gym"]}
            imagePosition={8}
          />
          <NetflixCard
            title="Home Gym"
            ...
            tags={["Home Gym", "COVID", "Dedication"]}
            imagePosition={7}
          />
          <NetflixCard
            title="Hyrox Barcelona"
            subtitle="First completion"
          ...
          <NetflixCard
            ...
            subtitle="Feeling ready"
            description="PreHalfMarathon - confident before the race."
            imageUrl="/images/PreHalfMarathon.jpeg"
            tags={["Half Marathon", "Pre-race", "Ready"]}
          />
          <NetflixCard
            ...
            tags={["Half Marathon", "Post-race", "Achievement"]}
          />
          <NetflixCard
          ...
          <NetflixCard
            ...
            description="I'm an artsy boy - embracing creativity."
          ...
          <NetflixCard
            ...
            tags={["Art", "Creative", "Journey"]}
          />
          <NetflixCard
            title="Artsy Boy 3"
            subtitle="Art life"
            description="I'm an artsy boy - living creatively."
            imageUrl="/images/artboy3.JPG"
            tags={["Art", "Creative", "Life"]}
          />
          <NetflixCard
            title="With Art"
            subtitle="Very fine"
          ...
          <NetflixCard
            ...
            description="My first flower arrangement (Yeah I made them myself) - creative skills."
          ...
          <NetflixCard
            title="Don't Smoke"
            subtitle="Just for aesthetics"
            description="I dont smoke but I feel cool af - aesthetic vibes only."
          ...
          <NetflixCard
            title="Got That DAWG"
            subtitle="WOOF WOOF"
            description="WOOF WOOF - got that dawg in me."
          ...
          />
          <NetflixCard
            title="Driving Dad's Van"
            subtitle="Favourite thing"
            description="One of my favourite things to do in life is drive my dads van - simple joys."
            imageUrl="/images/personas/suitors/me-driving-a-van.JPG"
            tags={["Van", "Dad", "Driving"]}
            imagePosition={7}
          />
          <NetflixCard
            title="Goofy Scream"
            subtitle="Life's too short"
            description="Goofy ah scream - don't take life too seriously."
          ...
          <NetflixCard
            ...
            description="In my BRAT era - embracing the energy."
            imageUrl="/images/brat.JPEG"
            tags={["Brat", "Era", "Energy"]}
          />
          <NetflixCard
            title="Bohs Maxxing"
            subtitle="Mon the Bohs"
            description="Mon the Bohs - supporting the local football team."
          ...
          <NetflixCard
            ...
            description="New Obsession - Darts. Completely hooked."
            imageUrl="/images/Darts.jpg"
            tags={["Darts", "Obsession", "Hobby"]}
            imagePosition={7}
          />
        </NavSection>
