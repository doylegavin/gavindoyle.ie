    ...
    <footer className="site-footer">
      <div className="footer-content">
        <div className="footer-info">
          <p>&copy; {currentYear} Gavin Doyle. All rights reserved.</p>
        </div>
        ...
        <div className="footer-socials">
          ...
          <a
            href="https://buymeacoffee.com/gavinthecraic"
            target="_blank"
            rel="noopener noreferrer"
            className="social-link coffee"
      ...
      <style jsx>{`
        ...
        .social-link.coffee:hover::before {
          width: 100%;
          height: 100%;
          opacity: 1;
          background: #FFDD00;
        ...
        .social-link.coffee:hover .social-icon {
          fill: #000;
        }
