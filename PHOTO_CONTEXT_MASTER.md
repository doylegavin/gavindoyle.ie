...
1. **Find any photo** - All photos are listed by category below
2. **See the context** - Context is shown after each filename
3. **Add missing context** - Empty spaces mean context is needed from you
4. **Reference usage** - See PHOTO_USAGE_TRACKER.md to see where photos are used
...
10 = TOP    (show the top of the photo - faces at top)
 ...
 7 = 
 6 = 
 5 = MIDDLE (default - center of photo)
 4 = 
 3 = 
 2 = 
 1 = BOTTOM (show the bottom of the photo - feet visible)
```
...
- `fav-basketball-photo.jpg` - WHITE MAN CAN JUMP {pos:3}
  → Shows mostly the bottom (captures the jump action)

- `vintage-paris.JPG` - Vintage lense of Paris {pos:5}
  → Shows the middle (default, no need to specify)
```
...
- **Landscapes/Wide shots** → Usually `{pos:5}` is fine

---

## 🏀 BASKETBALL PHOTOSHOOT SERIES
...
- `basketball-photoshoot-jump2.JPG` - DONT MESS WITH US {pos:8}
- `basketball-photoshoot-kicking.JPG` - Don't be getting fresh with me or this'll be you {pos:5}
- `basketball-photoshoot-laughig.JPG` - how cute {pos:8}
- `basketball-photoshoot-love.JPG` - we love love {pos:8}
- `basketball-photoshoot-pregnant.JPG` - This could us but you playin' {pos:5}
- `basketball-photoshoot-serious.JPG` - Woof woof {pos:9}
- `basketball-photoshoot-team.JPG` - Squad fr {pos:7}
- `basketball-photoshoot-wheelbarrow.JPG` - teamwork makes the dream work <3 {pos:5}
...
- `bball-scholarship.JPG` - How cute am I {pos:5}
- `fav-basketball-photo.jpg` - WHITE MAN CAN JUMP {pos:8}
- `graphic_of_me_player_of_the_game_basketball.JPG` - The Luka Doncic of Division 7 {pos:5}
...
## 🎓 SCHOOL/FORMAL EVENTS (Ardscoil Rís Basketball Team Success)
...
- `schoolball4.JPG` - We are immortalised forever on the Walls of Ardscoil Rís Sports Hall {pos:5}
...
- `me-and-luke-2018.JPG` - Back before we got fat {pos:8}
- `matty-in-ollies.JPG` - Matty is the king of Ollie's {pos:5}
- `me-and-kateoconnor-at-a-ball.JPG` - Glad to see one of my fans doing well for herself (Kate O'Connor, Olympian, World Silver medalist, Irish Sportsperson of the year) {pos:8}
- `selfie-with-luke-and-may.jpg` - One of my favourite past times is 3rd wheeling my best mate and his girlfriend {pos:5}
- `sad-boys.jpg` - The sad boys {pos:8}
- `belfastblur.jpg` - The whole year I lived in Beflast was a blur tbh {pos:5}
- `bigparisgroup.JPG` - D'Olympics Squad! {pos:5}
- `blessup.JPG` - BLESSUP {pos:5}
- `bophiebort.JPG` - MY GORGEOUS FRIEND SOPHIE {pos:5}
- `brat.JPEG` - In my BRAT era {pos:5}
...
- `gav-olympic-weightlifting.jpg` - I like lifting heavy things and putting them back down again {pos:5}
- `my-home-gym.JPG` - Home gym {pos:7}
- `olympic_weightlifting.JPG` - I like lifting heavy things and putting them back down again {pos:5}
...
- `vintage-paris.JPG` - Vintage lense of Paris {pos:5}
- `vintage-paris2.JPG` - Vintage lense of Paris {pos:5}
- `vintage-paris3.JPG` - Vintage lense of Paris {pos:5}
- `vintage-paris4.JPG` - Vintage lense of Paris {pos:5}
- `vintage-paris5.PNG` - Vintage lense of Paris {pos:5}
- `gone-fishing.JPG` - Fishing + pints + dad = great time {pos:5}
- `powerscourt.JPG` - HE LIVES UNDAAA A WAAATAA FALL {pos:5}
- `parents-first-trip-to-belfast.JPG` - Mam and Dad's first time in Beflast! {pos:5}
- `shipping-off-to-boston.JPG` - Shipping off to Boston!! Matty Beflast + Boston = Matty Boston {pos:5}
- `my-first-baseball-game.JPG` - Gavin's first baseball game x {pos:5}
- `passage-from-visitors-book-casements-sf.jpg` - A gorgeous passage from the Visitors book, Casement's Bar, Mission District, San Francisco {pos:5}
- `gav-in-scottish-mountains.jpg` - In the Scottish Mountains {pos:5}
- `gav-on-hike-scotland.jpg` - On a hike in Scotland {pos:5}
- `me-in-italy-out-for-drinks.JPG` - In Italy out for drinkies {pos:5}
...
- `hella-fruit.JPG` - The fruit bowl that HATES to see me and my housemates coming {pos:5}
- `mam-and-dad.JPG` - Adrienne and Tony {pos:5}
- `mattress-mick-wedding.JPG` - Posing getting a nice picture just so we could get a snap of MATTRESS MICK {pos:5}
- `miami-vice-audition.JPG` - Miami Vice Audition (didn't get the part) {pos:8}
- `mug-collection.JPG` - This is my mug collection {pos:5}
- `oh!-donuts-guy.PNG` - Hey man do you like oh! donuts man?? {pos:8}
- `shoota.JPG` - HE'S A SHOOTAAAA {pos:5}
- `tea.jpg` - Tea {pos:5}
- `woodwork-project.JPG` - Here's my LC woodwork project! {pos:5}
- `artboy.JPG` - I'm an artsy boy {pos:5}
- `artboy2.JPG` - I'm an artsy boy {pos:5}
...
- `me-getting-coffee.JPG` - Hey man do you like coffee man {pos:5}
...
- `examinaite-dashboard.svg` - **SVG placeholder** {pos:5}
- `examinaite-hero.svg` - **SVG placeholder** {pos:5}
- `examinaite-pdf.svg` - **SVG placeholder** {pos:5}
- `examinaite-questions.svg` - **SVG placeholder** {pos:5}
...
- `glorai-hero.svg` - **SVG placeholder** {pos:5}
- `glorai-chat.svg` - **SVG placeholder** {pos:5}
- `glorai-voice.svg` - **SVG placeholder** {pos:5}
...
- `dronan-contact.svg` - **SVG placeholder** {pos:5}
- `dronan-gallery.svg` - **SVG placeholder** {pos:5}
...
- `kneecapp-hero.svg` - **SVG placeholder** {pos:5}
- `kneecapp-lyrics.svg` - **SVG placeholder** {pos:5}
- `kneecapp-translation.svg` - **SVG placeholder** {pos:5}
...
- `giveago-builder-weekend.jpeg` - Make sure to check out give(a)go !! {pos:5}
...
- `IMG_2873.HEIC` - **NEEDS CONTEXT** (in Suitors folder) {pos:5}
- `IMG_2943.HEIC` - **NEEDS CONTEXT** (in Suitors folder) {pos:5}
- `IMG_6701.HEIC` - **NEEDS CONTEXT** (in Suitors folder) {pos:5}
- `IMG_6722.HEIC` - **NEEDS CONTEXT** (in Suitors folder) {pos:5}
- `IMG_6744.HEIC` - **NEEDS CONTEXT** (in Suitors folder) {pos:5}
...
- `ai-generated-pdfs-with-react.jpg` - **MISSING** - Cover for "Deep dive into @react-pdf/renderer" {pos:5}
- `prompt-engineering-for-education.jpg` - **MISSING** - Cover for "How to tune LLM prompts for Leaving Cert" {pos:5}
- `building-fast-with-nextjs.jpg` - **MISSING** - Cover for "My setup for rapid prototyping" {pos:5}
...
- **Employers:** 29 total files (16 used, 13 need context/unused)
- **Investors:** 13 total files (8 used, 5 need context/unused)
- **Techies:** 16 total files (13 used, 3 need context/unused)
